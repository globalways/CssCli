...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		...
		case R.id.return_scan_result:
			...
			break;
		/*
		 * case R.id.launch_product_query: Log.d(TAG,
		 ...
		 * PackageManager.MATCH_DEFAULT_ONLY); String browserPackageName = null;
		 * if (resolveInfo != null && resolveInfo.activityInfo != null) {
		 * browserPackageName = resolveInfo.activityInfo.packageName; Log.d(TAG,
		 * "Using browser in package " + browserPackageName); }
		 * 
		 * // Needed for default Android browser / Chrome only apparently if
		 ...
		 * 
		 * try { activity.startActivity(intent); } catch
		 * (ActivityNotFoundException ignored) { Log.w(TAG,
		 * "Can't find anything to handle VIEW of URI " + url); } break;
		 */
		}
	}
