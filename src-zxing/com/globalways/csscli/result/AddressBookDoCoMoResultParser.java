...
public final class AddressBookDoCoMoResultParser extends AbstractDoCoMoResultParser {
	...
	public AddressBookParsedResult parse(Result result) {
		...
		return new AddressBookParsedResult(maybeWrap(name), null, pronunciation, phoneNumbers, null, emails, null,
				null, note, addresses, null, org, birthday, null, urls, null);
	}
