...
package com.globalways.csscli.android.result;
...
import com.globalways.csscli.android.Contents;
import com.globalways.csscli.android.LocaleManager;
import com.globalways.csscli.android.PreferencesActivity;
import com.globalways.csscli.result.ParsedResult;
import com.globalways.csscli.result.ParsedResultType;
import com.globalways.csscli.result.ResultParser;
...
public abstract class ResultHandler {
	...
	final void searchBookContents(String isbnOrUrl) {
		 ...
		 * SearchBookContentsActivity.class.getName()); putExtra(intent,
		 * Intents.SearchBookContents.ISBN, isbnOrUrl); launchIntent(intent);
		 */
	}
