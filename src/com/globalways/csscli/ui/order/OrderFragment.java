...
import com.globalways.csscli.entity.OrderEntity.PayType;
...
public class OrderFragment extends BaseFragment implements OnClickListener, OnDateSetListener, OnRefreshListener<ListView>, OnItemClickListener {
	...
	//detail
	private TextView tvOrderID, tvBuyer, tvCard, tvOrderLastStatus, tvPaymentType,
	...
	private void showOrderDetail(OrderEntity e){
		...
		tvOrderCreateTime.setText(Tool.fenToYuan(e.getOrder_time()));
	...
	private class ProductListAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView)convertView.findViewById(R.id.tvProductCount)).setText(String.valueOf(list.get(position).getProduct_count()));
			((TextView)convertView.findViewById(R.id.tvProductUnit)).setText(list.get(position).getProduct_unit());
			return convertView;
		}
