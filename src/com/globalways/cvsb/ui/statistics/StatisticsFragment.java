...
import com.globalways.cvsb.entity.StatEntity;
...
public class StatisticsFragment extends Fragment implements OnClickListener, OnDateSetListener {
	...
	private TextView textAmount, textCount, textDiscount, textTotalAmount, textTotalDiscount, textTotalCount;
				...
				new ManagerCallBack2<StatEntity, String>() {
					...
					public void onSuccess(StatEntity returnContent, final String params) {
						...
						case StatType.TYPE_BUY:
							...
							textTotalAmount.setText("总采购金额(元)：￥" + returnContent.getTotal_amount());
							textTotalCount.setText("总采购数量：" + returnContent.getTotal_count());
							break;
						case StatType.TYPE_SELL:
							webViewStatistics.loadUrl("file:///android_asset/echarts/statOrder.html");
							textTotalDiscount.setVisibility(View.VISIBLE);
							textTotalDiscount.setText("总优惠金额(元)：￥" + returnContent.getTotal_discount());
							textTotalAmount.setText("总销售金额(元)：￥" + returnContent.getTotal_amount());
							textTotalCount.setText("总销售数量：" + returnContent.getTotal_count());
							break;
						}
	...
	private void initView() {
		...
		textAmount = (TextView) layoutView.findViewById(R.id.textAmount);
		textCount = (TextView) layoutView.findViewById(R.id.textCount);
		...
		case StatType.TYPE_BUY:
			...
			textAmount.setText("采购金额(元)");
			textCount.setText("采购数量");
			break;
		case StatType.TYPE_SELL:
			textDiscount.setVisibility(View.VISIBLE);
			textDiscount.setText("优惠金额(元)");
			textAmount.setText("销售金额(元)");
			textCount.setText("销售数量");
			break;
		}
