...
public class OrderEntity {
	...
	public OrderEntity(long id, String order_id, String ping_charge_id, int order_type, long store_id,
			...
			int last_status, long order_time, String products_count, String settle_serial_no, int settle_status,
			String last_status_desc, String created, String updated, String online_channel) {
		super();
		this.id = id;
		...
		this.online_channel = online_channel;
	}
	...
	public String toString() {
		return "OrderEntity [id=" + id + ", order_id=" + order_id + ", ping_charge_id=" + ping_charge_id
				...
				+ ", comment=" + comment + ", last_status=" + last_status + ", order_time=" + order_time
				+ ", products_count=" + products_count + ", settle_serial_no=" + settle_serial_no + ", settle_status="
				+ settle_status + ", last_status_desc=" + last_status_desc + ", created=" + created + ", updated="
				+ updated + ", online_channel=" + online_channel + "]";
	}
	...
	public void setOnline_channel(String online_channel) {
		this.online_channel = online_channel;
	}
	...
	public enum PayChannel {
		CASH("cash", "现金"), ALIPAY("alipay", "支付宝"), ALIPAY_QR("alipay_qr", "支付宝扫码"), UNKNOWN("", "未知");
		private String channel;
		public String channelName;

		private PayChannel(String channel, String name) {
			this.channel = channel;
			this.channelName = name;
		}

		public static PayChannel valueOf(String channel, int payType) {
			switch (channel) {
			case "alipay":
				return ALIPAY;
			case "alipay_qr":
				return ALIPAY_QR;
			case "":
				if (PayType.valueOf(payType) == PayType.CASH) {
					return CASH;
				} else {
					return UNKNOWN;
				}
