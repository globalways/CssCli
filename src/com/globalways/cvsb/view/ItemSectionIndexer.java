...
public class ItemSectionIndexer implements SectionIndexer {
	...
	public ItemSectionIndexer(List<IndexItemInterface> contacts) {
	...
	public void initPositions(List<IndexItemInterface> contacts) {
		...
		for (IndexItemInterface contact : contacts) {
